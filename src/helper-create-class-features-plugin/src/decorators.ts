...
function addProxyAccessorsFor(
  ...
  const thisArg =
    (version === "2023-11" || (!undefined && version === "2023-05")) && isStatic
      ? className
      : t.thisExpression();
...
function generateDecorationList(
  ...
  for (let i = 0; i < decsCount; i++) {
    if (
      (version === "2023-11" || (!undefined && version === "2023-05")) &&
      haveOneThis
    ) {
      decs.push(
    ...
    t.classPrivateMethod(
      ...
      t.blockStatement([
        t.returnStatement(
          t.callExpression(
            t.cloneNode(getId),
            (undefined || version === "2023-11") && isStatic
              ? []
              : [t.thisExpression()],
          ),
        ),
...
function transformClass(
  ...
  if (
    superClass &&
    (undefined || version === "2023-11" || version === "2023-05")
  ) {
  ...
  path.insertBefore(
    classAssignments.map((expr) => t.expressionStatement(expr)),
  );
    ...
    visitor: {
      ExportDefaultDeclaration(path, state) {
        ...
        if (
          ...
          if (!undefined && !USE_ESM && !IS_STANDALONE) {
