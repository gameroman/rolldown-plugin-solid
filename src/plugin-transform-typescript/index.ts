...
import { injectInitialization } from "../helper-create-class-features-plugin";
...
const pluginTransformTypescript = declare((api, opts: Options) => {
...
export default pluginTransformTypescript;
